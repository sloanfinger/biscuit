...
export default function CreateAccount() {
  ...
  return (
    ...
    >
      <h2 className="font-bold text-white md:text-xl lg:text-3xl">
        Create Account
      </h2>
      ...
      <fieldset className="w-full space-y-7">
        <label className="w-full space-y-1.5">
          ...
          <span className="relative block">
            <input
              autoComplete="off"
              className="peer form-input w-full rounded-md border-2 border-zinc-500 bg-transparent p-2 pl-12 lowercase text-white placeholder:text-zinc-500 focus:border-amber-400 focus:ring-amber-300/25 disabled:cursor-not-allowed disabled:opacity-80"
              disabled={isPending}
              maxLength={16}
              minLength={4}
              name="username"
        ...
        <label className="relative block w-full space-y-1.5">
          ...
          <input
            className="peer form-input w-full rounded-md border-2 border-zinc-500 bg-transparent p-2 pl-12 text-white placeholder:text-zinc-500 focus:border-amber-400 focus:ring-amber-300/25 disabled:cursor-not-allowed disabled:opacity-80"
            minLength={8}
            name="password"
      ...
      <button
        className="grid rounded-md border-2 border-green-800 bg-gradient-to-b from-green-400 to-green-500 px-6 py-2 text-zinc-950 disabled:cursor-not-allowed disabled:opacity-80 md:w-1/2 lg:w-3/4"
        disabled={isPending}
        role="button"
      >
        <span
      ...
      <p className="-mb-2 flex w-full flex-col-reverse items-center justify-center text-sm text-zinc-400 sm:-mb-7 sm:mt-3 sm:flex-row lg:text-base">
        <Link
