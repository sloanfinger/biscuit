  ...
  return (
    <div className="@container">
      <article className="flex grid-cols-[8rem_auto] grid-rows-[8rem_auto] flex-col gap-[1.125rem] gap-x-6 rounded-md bg-zinc-800 px-2 py-1.5 shadow-sm @[16rem]:px-4 @[16rem]:py-[1.125rem] @md:grid @md:items-center @md:gap-y-3">
        ...
        >
          {review.content ? (
            <span className="flex flex-1 flex-col justify-center overflow-hidden rounded-r-md border-l-[3px] border-zinc-600 px-3 py-0.5 text-sm text-white transition-colors hover:bg-zinc-700 @[16rem]:pb-0 @[16rem]:text-base">
